  ...
  return (
    <>
      <div className="flex items-center justify-center w-screen h-screen bg-teal-500 relative">
        ...
        {showModal && (
          <div className="absolute w-screen h-screen bg-black/25 flex justify-center items-center">
            <dialog open onClick={(e) => e.stopPropagation} className="w-[500px] h-[300px]">
